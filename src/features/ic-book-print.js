...
function buildICBook(core, rec, d, c){
  ...
  <div class="memo" data-print-date="${esc(core.fmtDateBilingual(core.todayStr()))}">
    ...
    <div class="print-letterhead">
      ...
      <div class="print-letterhead-text">
        ...
        <div class="print-letterhead-app">${T('منصة ذكاء الاستثمار العقاري','Opal Real Estate Intelligence')} · Opal Real Estate Intelligence</div>
  ...
  html += sec(core, 21, 'المصادر والأدلة وإخلاء المسؤولية', 'Sources / Evidence / Disclaimer', 'Sources / Evidence / Disclaimer', `
    ...
    <p style="margin:12px 0 0; font-size:11px; line-height:1.8; color:var(--ink-faint);">
      ${T('هذا الكتاب أُعِدَّ آلياً من بيانات مُدخَلة داخل تطبيق منصة ذكاء الاستثمار العقاري، ويستند إلى الافتراضات المُدخَلة من المحلل المسؤول وقت الإعداد. الأرقام هنا تقديرية ولا تُغني عن تقييم مستقل معتمد أو مراجعة قانونية/ضريبية/شرعية متخصصة قبل اتخاذ أي قرار استثماري نهائي. جميع الحقوق محفوظة.',
        'This book was automatically compiled from data entered into Opal Real Estate Intelligence, and is based on assumptions entered by the responsible analyst at the time of preparation. Figures here are estimates and do not substitute for an accredited independent valuation or specialized legal/tax/Sharia review before any final investment decision. All rights reserved.')}
    </p>
  `);
